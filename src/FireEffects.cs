...
namespace Landis.Extension.Succession.NECN
{
    ...
    public class FireEffects
    {
        ...
        public static void Initialize(IInputParameters parameters)
        {
            ...
            //kate added line directly below
            //this dind't work
            PlugIn.ModelCore.UI.WriteLine("    Printing fire reduction parameters {0} ", ReductionsTable);
        }
        ...
        public static void ReduceLayers(byte severity, Site site)
        {
            ...
            try
            {
                ...
                //kate
                PlugIn.ModelCore.UI.WriteLine("   Fire severity is {0}", ReductionsTable[severity]);
                PlugIn.ModelCore.UI.WriteLine("   Fine litter reduction value for that severity is {0}", fineLitterReduction);
            ...
            //kate
            //PlugIn.ModelCore.UI.WriteLine("   Carbon value pre-fire is {0}", SiteVars.SurfaceStructural[site].Carbon);
            //PlugIn.ModelCore.UI.WriteLine("   Carbon loss is {0}", carbonLoss);

            //kate
            PlugIn.ModelCore.UI.WriteLine("   Surface Structural (litter) value pre-fire is {0}", SiteVars.SurfaceStructural[site].Carbon);
            //PlugIn.ModelCore.UI.WriteLine("   Fine litter reduction based on severity is {0}", fineLitterReduction);
            PlugIn.ModelCore.UI.WriteLine("   Surface Structural (litter) carbon loss is {0}", carbonLoss);
            ...
            //kate
            PlugIn.ModelCore.UI.WriteLine("   Surface dead wood value pre-fire is {0}", SiteVars.SurfaceDeadWood[site].Carbon);
            PlugIn.ModelCore.UI.WriteLine("   Surface dead wood multiplier (reduction) based on severity is {0}", woodLossMultiplier);
            PlugIn.ModelCore.UI.WriteLine("   Surface dead wood loss is {0}", carbonLoss);
            ...
            //kate
            PlugIn.ModelCore.UI.WriteLine("   SOM1 value pre-fire is {0}", SiteVars.SOM1surface[site].Carbon);
            PlugIn.ModelCore.UI.WriteLine("   SOM1 multiplier (reduction) based on severity is {0}", SOM_Multiplier);
            PlugIn.ModelCore.UI.WriteLine("   SOM1 loss is {0}", carbonLoss);
